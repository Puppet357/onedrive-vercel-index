...
module.exports = {
  ...
  //userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Puppet.L@trees.center',
  
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '<script src="https://v1.hitokoto.cn/?encode=js&select=%23hitokoto" defer></script>',
  ...
  title: "Puppet.L's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/PublicSharing',
